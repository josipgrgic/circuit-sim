function XorGate(x, y) {
    ...
    this.draw = function() {
        ...
        arc(this.x - this.length - 24, this.y + this.height / 2, 2 * this.height + 1, 2 * this.height - 1, -(1 / 3) * HALF_PI, (1 / 3) * HALF_PI);

        arc(this.x - this.length - 18, this.y + this.height / 2, 2 * this.height + 1, 2 * this.height - 1, -(1 / 3) * HALF_PI, (1 / 3) * HALF_PI);

        arc(this.x + this.length, this.y + this.height / 2, this.length + 30, this.height, 3 * HALF_PI, HALF_PI);
    ...
    this.refresh = function(index) {
        ...
        this.index = index;
        this.name = "XOR_GATE_" + this.index;
