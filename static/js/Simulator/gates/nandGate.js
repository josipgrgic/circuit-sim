function NandGate(x, y) {
    ...
    this.index = -1;
    this.name = "NAND_GATE_";

    this.length = 20;
    this.height = 40;

    this.left = this.x - 20;
    this.right = this.x + (3 / 2) * this.length + 38;
    this.up = this.y;
    ...
    this.draw = function() {
        ...
        ellipse(this.x + this.length + 23, this.y + this.height / 2, 10, 10);
        ...
        for (i = 0; i < this.outputNum; i++) {
            line(this.right - 20, this.y + (i + 1) * this.height / (this.outputNum + 1), this.right - 4, this.y + (i + 1) * this.height / (this.outputNum + 1));
        }
    ...
    this.set = function() {
        ...
        for (i = 0; i < this.outputNum; i++) {
            ...
            this.out[i].setPosition(this.right - 3, this.y + (i + 1) * this.height / (this.outputNum + 1));
        }
    ...
    this.refresh = function(index) {
        ...
        this.index = index;
        this.name = "NAND_GATE_" + this.index;
